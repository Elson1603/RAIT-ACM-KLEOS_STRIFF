            ...
            NavHost(
                ...
                composable("home") {
                    HomeScreen(
                        ...
                        onNavigateToFullMap = { navigateTo("full_map") },
                        onNavigateToNearbySafety = { navigateTo("nearby_safety") },
...
private fun AppDrawer(
    ...
    val destinations = remember {
        listOf(
            ...
            DrawerDestination("nearby_safety", "Nearby Safety", Icons.Default.LocationOn),
            DrawerDestination("full_map", "Full Map", Icons.Default.Map),
